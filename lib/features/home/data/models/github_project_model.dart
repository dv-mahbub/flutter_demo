...
GithubProjectModel githubProjectModelFromJson(String str) =>
    GithubProjectModel.fromJson(json.decode(str));

String githubProjectModelToJson(GithubProjectModel data) =>
